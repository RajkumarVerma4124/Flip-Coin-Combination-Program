...
echo "Switch case For Singlet Doublet And Triplet"
printf "\n"
while [ true ]
do
	echo "1. Enter "1" To Get The Results In Singlet"
	echo "2. Enter "2" To Get The Results In Doublet"
	echo "3. Enter "3" To Get The Results In Triplet"
	echo "4. Enter "4" To Exit The  Simulation"
	read -p "Enter the choice from above statement : " choice
	...
	*)
	printf "\n"
	echo "Invalid Choice Choose The Number From 1 to 4 "
	printf "\n"
	;;
